...
Since my implementation used only the onboard SRAM, memory delays were a very small cost. Using the DRAM expansion could have decreased memory performance, but allowed for the evaluation of much larger circuits. \comment{Clarify this}
